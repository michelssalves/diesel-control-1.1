    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-md-auto mt-4">
                <form action="controle-de-veiculos" method="POST">
                    ...
                    <a href="controle-de-veiculos?page=1"><button name="page" value="1" type="submit" class='btn btn-warning btn-sm'>Filtrar</button></a>
