...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item ml-30">
                        <a href="menu-principal-novo" class="btn btn-primary btn-sm">Voltar</a>
                        <a href="logout-novo" class="btn btn-danger btn-sm">Sair</a>
                    </li>
                </ul>
    ...
    <form method="POST">
        ...
        <div class="input-group input-group-sm mb-3">
            ...
            <input readonly id="ultimohr" name="ultimoHrCad" type="text" class="form-control"  aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Ultimo Horimetro" autofocus required>
        </div>
        ...
        <div class="input-group input-group-sm mb-3">
            ...
            <input readonly id="diferencahr" name="diferencaHrCad" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Diferenca Horimetro" autofocus required>
        </div>
        <div class="input-group input-group-sm mb-3">
